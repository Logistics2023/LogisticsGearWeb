...
function Home({ children }) {
  ...
  return (
    <div className="min-h-screen ">
      <div className={`fixed top-0 w-screen lg:w-screen lg:border-r-8   h-screen bg-[#000618] h-screen transition-all	z-50  ${nav ? 'left-0  ' : 'left-[-100vw] '} z-50`} >
        <div class="py-4 overflow-y-auto ">
        <div className="w-[100%] text-[16px] flex justify-between items-center">
                <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" onClick={()=>setNav(false)}>
      ...
      <main className={`relative min-w-screen  lg:pb-0  lg:min-w-auto my-[0px]  lg:bg-blue-50 lg:min-h-screen  ${nav ? 'w-screen pl-[100vw]  ' : '  lg:px-[0px]'}`} onClick={() => setNav(false)} style={{ transition: 'all 0.5' }}>
       
        <nav class="absolute w-screen lg:border-gray-200 dark:bg-gray-900">
              <div class="w-screen flex flex-wrap items-center justify-between lg:border-b-[2px] lg:border-gray-50 mx-auto py-4 px-4 lg:px-8">
                ...
                <div class="hidden w-screen md:block md:w-auto" id="navbar-default">
                  <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-8  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                      <a href="#" class="block py-2 pl-3 pr-4 text-white text-[14px] bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white text-[14px] md:dark:text-blue-500" aria-current="page">Home</a>
                    </li>
                    <li>
                      <a href="#" class="block py-2 pl-3 pr-4 text-white text-[14px] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white text-[14px] md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white text-[14px] md:dark:hover:bg-transparent">About</a>
                    </li>
                    <li>
                      <a href="#" class="block py-2 pl-3 pr-4 text-white text-[14px] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white text-[14px] md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white text-[14px] md:dark:hover:bg-transparent">Services</a>
                    </li>
                    <li>
                      <a href="#" class="block py-2 pl-3 pr-4 text-white text-[14px] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white text-[14px] md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white text-[14px] md:dark:hover:bg-transparent">Pricing</a>
                    </li>
                    <li>
                      <a href="#" class="block py-2 pl-3 pr-4 text-white text-[14px] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white text-[14px] md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white text-[14px] md:dark:hover:bg-transparent">Contact</a>
                    </li>
                  </ul>
                </div>
              </div>
